...
// 	$inseart_query = "INSERT INTO users(first_name,last_name,email,phone) VALUES('$fname','$lname','$email','$number') ";
// 	$result =  mysqli_query($con,$inseart_query);
...
// if (isset($_POST['id']) && isset($_POST['id']) !=null) {
// 	$user_id = $_POST['id'];
...
// 	$user_id = $_POST['hidden_user_id_update'];
// 	$new_fname = $_POST['new_fname'];
// 	$new_lname = $_POST['new_lname'];
// 	$new_email = $_POST['new_email'];
// 	$new_number = $_POST['new_number'];

// 	$update_query = "UPDATE users SET first_name='$new_fname',last_name='$new_lname',email='$new_email',phone='$new_number' WHERE id=$user_id";
